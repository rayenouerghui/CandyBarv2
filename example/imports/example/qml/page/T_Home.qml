...
FluScrollablePage{
    ...
    ListModel{
        id: model_header
        ListElement{
            icon: "qrc:/example/res/image/genical.jpg"
            title: qsTr("CandyBarV2 GitHub")
            desc: qsTr("The latest CandyBarV2 controls and styles for your applications.")
        ...
        ListElement{
            icon: "qrc:/example/res/image/genical.jpg"
            title: qsTr("CandyBarV2 Initializr")
            desc: qsTr("CandyBarV2 Initializr is a Tool that helps you create and customize projects with various options.")
            url: "https://github.com/zhuzichu520/FluentUI"
            clicked: function(model){
