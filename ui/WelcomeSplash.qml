...
Item {
    ...
    // Static splash for lightweight devices — set final visuals and immediately signal completion
    Component.onCompleted: {
        brand_cluster.opacity = 1
        brand_lift.y = 0
        splash_title.opacity = 1
        splash_sub.opacity = 0.65
        splash_line.width = 52
        root.splashComplete()
    }
}
